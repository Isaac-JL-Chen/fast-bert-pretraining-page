...
Example for downloading and sharding [Wikipedia](https://huggingface.co/datasets/wikipedia) dataset with subset name `--huggingface_wiki_config` from Huggingface in one click:
...
Example for downloading and sharding [Bookcorpus](https://huggingface.co/datasets/bookcorpusopen) dataset from Huggingface in one click:
